...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="user", database="network")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            sql = "insert into info2 values(%s,%s,%s,%s)"
    ...
    def login_varify(self):
            ...
            sql = "select * from info2 where username = %s and passwd = %s"
    ...
    def main_screen(self):
        ...
        Label(root, text="Welcome to Log-In Portal", font="bold", bg="grey", fg="black", width=300).pack()
