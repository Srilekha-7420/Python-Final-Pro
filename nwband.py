...
label_upload_header = tk.Label(text="Total Upload speed:", font="Quicksand 12 bold")
label_upload_header.pack()
label_upload= tk.Label(text="Calculating...", font="Quicksand 12")
label_upload.pack()

label_download_header = tk.Label(text="Total Download speed:", font="Quicksand 12 bold")
