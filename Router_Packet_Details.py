...
class Router_Packet_details:
    def get_packet_details():
        router = {
                "device_type":"cisco_ios","ip":"sandbox-iosxe-latest-1.cisco.com","username":"developer","password":"C1sco12345"
                }
...
Thread1 = Thread(target =Router_Packet_details.get_packet_details())
Thread2 = Thread(target =Router_Packet_details.get_packet_details())
Thread1.start()
Thread2.start()
Thread1.join()
Thread2.join()